...
const char * const BITCOIN_CONF_FILENAME = "naqd.conf";
const char * const BITCOIN_PID_FILENAME = "naqdd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NAQD";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/NAQD";
#else
    // Unix
    return pathRet / ".naqd";
#endif
