...
"""Verify that starting naqd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start naqd with -h for help text")
        ...
        self.log.info("Start naqd with -version for version information")
