...
#if defined(NDEBUG)
# error "NAQD cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "NAQD Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s NQD additional fees, %d delta bytes\n",
