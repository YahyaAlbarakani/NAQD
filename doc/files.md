...
* naqd.conf: contains configuration settings for naqdd or naqd-qt
* naqdd.pid: stores the process id of naqdd while running
...
* debug.log: contains debug information and general logging generated by naqdd or naqd-qt
